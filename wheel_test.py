...
class WheelTest:
    ...
    def testDrive(self, ticks=30, dist=1):
        ...
        '''BL: Modified based on our set_velocity'''
        self.ppi.tick = ticks
        self.ppi.turning_tick = 0 
        self.ppi.set_velocity([1, 0], dt)
    ...
    def testTurn(self, turning_ticks=10, theta=2*np.pi):
        ...
        '''BL: Modified based on our set_velocity'''
        self.ppi.tick = 0
        self.ppi.turning_tick = turning_ticks
        self.ppi.set_velocity([0, 1], dt)
