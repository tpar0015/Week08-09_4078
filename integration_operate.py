...
parser.add_argument("--aruco_size", type=int, default=400)
parser.add_argument("--fruit_size", type=int, default=400)
...
try:
    if a_star_navi:
        arena = Map((3000,3000), 50, true_map=args.map, shopping_list=args.shop, aruco_size=(args.aruco_size,args.aruco_size), fruit_size=(args.fruit_size, args.fruit_size), distance_threshold=args.waypoint_threshold)
        arena.generate_map()
