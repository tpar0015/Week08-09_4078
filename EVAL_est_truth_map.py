...
def parse_map_for_plot(fname):
    ...
    for key in gt_dict:
        ...
        # read target map
            ...
            # just read in like the way we read SLAM
            fruit = key
            target_dict[fruit] = np.reshape([gt_dict[key]['x'], gt_dict[key]['y']], (2, 1)) 
...
def plot_full_map(fname, color = 'r', alpha = 0.5):
    aruco_dict, target_dict = parse_map_for_plot(fname)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--slam', type=str, default='lab_output/slam_runX_412.txt')
    parser.add_argument('--target', type=str, default='lab_output/targets_runX_412.txt')
    ...
    if slam_only:
        ...
        plot_full_map(args.est_map, color='r', alpha=1)
